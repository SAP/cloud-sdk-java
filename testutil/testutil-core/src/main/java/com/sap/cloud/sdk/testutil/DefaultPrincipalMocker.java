...
class DefaultPrincipalMocker implements PrincipalMocker
{
    ...
    private static class GetAttributeMockitoAnswer
        implements
        Answer<Try<com.sap.cloud.sdk.cloudplatform.security.principal.PrincipalAttribute>>
    {
        private final Map<String, com.sap.cloud.sdk.cloudplatform.security.principal.PrincipalAttribute> attributes;

        @Override
        public Try<com.sap.cloud.sdk.cloudplatform.security.principal.PrincipalAttribute> answer(
