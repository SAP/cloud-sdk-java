...
1.  **[Project activity](#project-activity)**: **5.54** (weight is 0.5)
...
Score: **5.54**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 294
