...
1.  **[Project activity](#project-activity)**: **7.69** (weight is 0.5)
...
Score: **7.69**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 287
