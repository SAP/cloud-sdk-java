...
1.  **[Project activity](#project-activity)**: **8.62** (weight is 0.5)
...
Score: **8.62**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 266
