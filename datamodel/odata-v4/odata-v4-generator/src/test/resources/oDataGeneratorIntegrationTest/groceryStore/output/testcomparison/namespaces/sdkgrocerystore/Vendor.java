    ...
    extends VdmEntity<Vendor>
{
    ...
    @ElementName("Id")
    private Integer id;
    public final static SimpleProperty.NumericInteger<Vendor> ID = new SimpleProperty.NumericInteger<Vendor>(Vendor.class, "Id");
    /**
     * Constraints: Nullable, Maximum length: 100 <p>Original property name from the Odata EDM: <b>Name</b></p>
     * 
     * @return
     ...
     * 
     * @return
     *     The addressId contained in this {@link VdmEntity}.
     */
    @Nullable
    @ElementName("AddressId")
    private Integer addressId;
    public final static SimpleProperty.NumericInteger<Vendor> ADDRESS_ID = new SimpleProperty.NumericInteger<Vendor>(Vendor.class, "AddressId");
    /**
     ...
     * 
     */
    public final static com.sap.cloud.sdk.datamodel.odatav4.core.NavigationProperty.Single<Vendor, Address> TO_ADDRESS = new com.sap.cloud.sdk.datamodel.odatav4.core.NavigationProperty.Single<Vendor, Address>(Vendor.class, "Address", Address.class);
