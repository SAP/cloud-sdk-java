    ...
    extends VdmEntity<FloorPlan>
{
    ...
    @ElementName("Id")
    private Integer id;
    public final static SimpleProperty.NumericInteger<FloorPlan> ID = new SimpleProperty.NumericInteger<FloorPlan>(FloorPlan.class, "Id");
    /**
     * Constraints: Nullable<p>Original property name from the Odata EDM: <b>ImageUri</b></p>
     * 
     * @return
     *     The imageUri contained in this {@link VdmEntity}.
     */
    @Nullable
    @ElementName("ImageUri")
    private java.lang.String imageUri;
    public final static SimpleProperty.String<FloorPlan> IMAGE_URI = new SimpleProperty.String<FloorPlan>(FloorPlan.class, "ImageUri");
    ...
    public void setImageUri(
        @Nullable
        final java.lang.String imageUri) {
