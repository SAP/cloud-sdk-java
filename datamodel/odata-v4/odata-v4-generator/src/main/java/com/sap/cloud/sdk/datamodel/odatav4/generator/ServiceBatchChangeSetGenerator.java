 ...
 */
/**
 * This method takes the given method of the general service interface as a blue print to create the batch counterpart
 ...
 *//*
   ...
   private JMethod addMethod( final JDefinedClass interfaceToAddTo, final JMethod interfaceMethod )
   {
    ...
    methodAdded.javadoc().addReturn().add(
