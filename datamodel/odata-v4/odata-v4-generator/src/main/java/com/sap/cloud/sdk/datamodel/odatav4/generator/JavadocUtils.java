...
class JavadocUtils
{
    ...
    {
        final String documentationElementString = element.getAnnotations().getDescription();
        if( !Strings.isNullOrEmpty(documentationElementString) ) {
            return documentationElementString;
        }
        String descriptionAttribute = element.getAnnotations().getQuickInfo();
        if( descriptionAttribute == null ) {
            descriptionAttribute = element.getAnnotations().getLabel();
        }
        if( descriptionAttribute != null ) {
    ...
    static String getDetailedDescription( final Service.Annotatable element )
    {
        final String documentationElementString = element.getAnnotations().getLongDescription();
        if( !Strings.isNullOrEmpty(documentationElementString) ) {
            return documentationElementString;
        }
        return "";
    ...
    static String getConstraints( final Service.Element element )
    {
        String parameterConstraintsString = "Constraints: ";

        final Service.Facets parameterFacets = element.getFacets();
