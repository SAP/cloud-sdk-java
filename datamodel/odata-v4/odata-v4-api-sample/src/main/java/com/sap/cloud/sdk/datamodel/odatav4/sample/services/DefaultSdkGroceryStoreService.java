    ...
    implements ServiceWithNavigableEntities, SdkGroceryStoreService
{
    ...
    @Override
    @Nonnull
    public CreateRequestBuilder<Receipt> createReceipts(
        @Nonnull
    ...
    @Override
    @Nonnull
    public UpdateRequestBuilder<Receipt> updateReceipts(
        @Nonnull
        final Receipt receipt) {
    ...
    @Override
    @Nonnull
    public DeleteRequestBuilder<Receipt> deleteReceipts(
        @Nonnull
        final Receipt receipt) {
    ...
    @Override
    @Nonnull
    public CreateRequestBuilder<Address> createAddresses(
        @Nonnull
    ...
    @Override
    @Nonnull
    public UpdateRequestBuilder<Address> updateAddresses(
        @Nonnull
        final Address address) {
    ...
    @Override
    @Nonnull
    public DeleteRequestBuilder<Address> deleteAddresses(
        @Nonnull
        final Address address) {
    ...
    @Override
    @Nonnull
    public CreateRequestBuilder<Shelf> createShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public UpdateRequestBuilder<Shelf> updateShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public DeleteRequestBuilder<Shelf> deleteShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public CreateRequestBuilder<Shelf> createShopFloorShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public UpdateRequestBuilder<Shelf> updateShopFloorShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public DeleteRequestBuilder<Shelf> deleteShopFloorShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public CreateRequestBuilder<Shelf> createStorageShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public UpdateRequestBuilder<Shelf> updateStorageShelves(
        @Nonnull
        final Shelf shelf) {
    ...
    @Override
    @Nonnull
    public DeleteRequestBuilder<Shelf> deleteStorageShelves(
        @Nonnull
        final Shelf shelf) {
