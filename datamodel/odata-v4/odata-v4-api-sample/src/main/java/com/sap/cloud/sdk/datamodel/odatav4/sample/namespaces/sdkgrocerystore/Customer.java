...
public class Customer extends VdmEntity<Customer> implements VdmEntitySet
{
    ...
    @ElementName( "Id" )
    private Integer id;
    public final static SimpleProperty.NumericInteger<Customer> ID =
        new SimpleProperty.NumericInteger<Customer>(Customer.class, "Id");
    /**
    ...
    public final static SimpleProperty.String<Customer> NAME =
        new SimpleProperty.String<Customer>(Customer.class, "Name");
    /**
    ...
    public final static SimpleProperty.String<Customer> EMAIL =
        new SimpleProperty.String<Customer>(Customer.class, "Email");
    /**
     ...
     * </p>
     *
     * @return ID of the customer's address.
     */
    @Nullable
    @ElementName( "AddressId" )
    private Integer addressId;
    public final static SimpleProperty.NumericInteger<Customer> ADDRESS_ID =
        new SimpleProperty.NumericInteger<Customer>(Customer.class, "AddressId");
    /**
     ...
     *
     */
    public final static com.sap.cloud.sdk.datamodel.odatav4.core.NavigationProperty.Single<Customer, Address> TO_ADDRESS =
        new com.sap.cloud.sdk.datamodel.odatav4.core.NavigationProperty.Single<Customer, Address>(
            Customer.class,
            "Address",
            Address.class);
     ...
     */
    public void setEmail( @Nullable final java.lang.String email )
    {
    ...
    protected void fromMap( final Map<java.lang.String, Object> inputValues )
    {
        ...
        // simple properties
        {
            ...
            if( cloudSdkValues.containsKey("Email") ) {
                final Object cloudSdkValue = cloudSdkValues.remove("Email");
                if( (cloudSdkValue == null) || (!cloudSdkValue.equals(getEmail())) ) {
                    setEmail(((java.lang.String) cloudSdkValue));
                }
            }
    ...
    @Nonnull
    public static
        com.sap.cloud.sdk.datamodel.odatav4.core.BoundAction.SingleToSingle<Customer, Void>
        orderProduct( @Nonnull final Integer productId, @Nonnull final Integer quantity )
    {
        final Map<java.lang.String, Object> parameters = new HashMap<java.lang.String, Object>();
        parameters.put("ProductId", productId);
        parameters.put("Quantity", quantity);
        return new com.sap.cloud.sdk.datamodel.odatav4.core.BoundAction.SingleToSingle<Customer, Void>(
            Customer.class,
            Void.class,
            "com.sap.cloud.sdk.store.grocery.OrderProduct",
            parameters);
    }
     ...
     *            Constraints: Nullable
     *            <p>
     *            Original parameter name from the Odata EDM: <b>Receipts</b>
     *            </p>
     * @param productCategories
     *            Constraints: Nullable
     *            <p>
     *            Original parameter name from the Odata EDM: <b>ProductCategories</b>
     *            </p>
     * @param dateRange
     *            Constraints: Nullable
     *            <p>
     *            Original parameter name from the Odata EDM: <b>DateRange</b>
     *            </p>
     * @param productNames
     *            Constraints: Nullable
     *            <p>
     *            Original parameter name from the Odata EDM: <b>ProductNames</b>
     *            </p>
     * @return Action object prepared with the given parameters to be applied to any entity object of this class.
     *         </p>
     *         To execute it use the {@code service.forEntity(entity).applyAction(thisAction)} API.
    ...
    @Nonnull
    public static
        com.sap.cloud.sdk.datamodel.odatav4.core.BoundAction.SingleToCollection<Customer, PurchaseHistoryItem>
        filterPurchaseHistory(
            @Nullable final Collection<Receipt> receipts,
            @Nullable final Collection<java.lang.String> productNames,
            @Nullable final Collection<ProductCategory> productCategories,
            @Nullable final DateRange dateRange )
    {
        final Map<java.lang.String, Object> parameters = new HashMap<java.lang.String, Object>();
        ...
        return new com.sap.cloud.sdk.datamodel.odatav4.core.BoundAction.SingleToCollection<Customer, PurchaseHistoryItem>(
            Customer.class,
            PurchaseHistoryItem.class,
            "com.sap.cloud.sdk.store.grocery.FilterPurchaseHistory",
            parameters);
    }
