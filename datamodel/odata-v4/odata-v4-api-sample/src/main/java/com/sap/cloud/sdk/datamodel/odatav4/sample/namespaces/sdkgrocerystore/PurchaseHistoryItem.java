...
/**
 * <p>
 * Original complex type name from the Odata EDM: <b>PurchaseHistoryItem</b>
 * </p>
 *
 */
@Builder
...
public class PurchaseHistoryItem extends VdmComplex<PurchaseHistoryItem>
{
     ...
     * <p>
     * Original property name from the Odata EDM: <b>ReceiptId</b>
     * </p>
     *
     * @return The receiptId contained in this {@link VdmComplex}.
     */
    @Nullable
    @ElementName( "ReceiptId" )
    private Integer receiptId;
    public final static com.sap.cloud.sdk.datamodel.odatav4.core.SimpleProperty.NumericInteger<PurchaseHistoryItem> RECEIPT_ID =
        new com.sap.cloud.sdk.datamodel.odatav4.core.SimpleProperty.NumericInteger<PurchaseHistoryItem>(
            PurchaseHistoryItem.class,
            "ReceiptId");
    /**
     * Constraints: Not nullable
     * <p>
     * Original property name from the Odata EDM: <b>ProductCount</b>
     * </p>
     *
     * @return The productCount contained in this {@link VdmComplex}.
     */
    @Nullable
     ...
     *
     */
    public final static com.sap.cloud.sdk.datamodel.odatav4.core.ComplexProperty.Single<PurchaseHistoryItem, ProductCount> PRODUCT_COUNT =
        new com.sap.cloud.sdk.datamodel.odatav4.core.ComplexProperty.Single<PurchaseHistoryItem, ProductCount>(
            PurchaseHistoryItem.class,
            "ProductCount",
            ProductCount.class);
     ...
     */
    public void setReceiptId( @Nullable final Integer receiptId )
    {
     ...
     */
    public void setProductCount( @Nullable final ProductCount productCount )
    {
