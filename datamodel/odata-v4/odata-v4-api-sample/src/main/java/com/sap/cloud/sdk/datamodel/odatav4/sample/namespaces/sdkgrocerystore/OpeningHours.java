...
public class OpeningHours extends VdmEntity<OpeningHours> implements VdmEntitySet
{
    ...
    @ElementName( "Id" )
    private Integer id;
    public final static SimpleProperty.NumericInteger<OpeningHours> ID =
        new SimpleProperty.NumericInteger<OpeningHours>(OpeningHours.class, "Id");
    /**
     ...
     * </p>
     *
     * @return The dayOfWeek contained in this {@link VdmEntity}.
     */
    @Nullable
    @ElementName( "DayOfWeek" )
    private Integer dayOfWeek;
    public final static SimpleProperty.NumericInteger<OpeningHours> DAY_OF_WEEK =
        new SimpleProperty.NumericInteger<OpeningHours>(OpeningHours.class, "DayOfWeek");
    /**
     * Constraints: Not nullable
     * <p>
     ...
     * </p>
     *
     * @return The openTime contained in this {@link VdmEntity}.
     */
    @Nullable
    @ElementName( "OpenTime" )
    private LocalTime openTime;
    public final static SimpleProperty.Time<OpeningHours> OPEN_TIME =
        new SimpleProperty.Time<OpeningHours>(OpeningHours.class, "OpenTime");
    /**
     * Constraints: Not nullable
     * <p>
     ...
     * </p>
     *
     * @return The closeTime contained in this {@link VdmEntity}.
     */
    @Nullable
    @ElementName( "CloseTime" )
    private LocalTime closeTime;
    public final static SimpleProperty.Time<OpeningHours> CLOSE_TIME =
        new SimpleProperty.Time<OpeningHours>(OpeningHours.class, "CloseTime");
    ...
    @Nonnull
    public static
        com.sap.cloud.sdk.datamodel.odatav4.core.BoundFunction.SingleToSingle<OpeningHours, Boolean>
        isStoreOpen( @Nonnull final OffsetDateTime dateTime )
    {
        final Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put("DateTime", dateTime);
        return new com.sap.cloud.sdk.datamodel.odatav4.core.BoundFunction.SingleToSingle<OpeningHours, Boolean>(
            OpeningHours.class,
            Boolean.class,
            "com.sap.cloud.sdk.store.grocery.IsStoreOpen",
            parameters);
    }
