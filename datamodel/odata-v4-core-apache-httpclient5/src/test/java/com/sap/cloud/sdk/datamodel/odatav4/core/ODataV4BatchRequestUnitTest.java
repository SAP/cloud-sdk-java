...
class ODataV4BatchRequestUnitTest
{
    ...
    void testBatchOpenConnection()
    {
        ...
        when(httpClient.executeOpen(isNull(), argThat(req -> req instanceof HttpPost), isNull())).thenAnswer(args -> {
            ...
            response.setEntity(new InputStreamEntity(inStream, ContentType.APPLICATION_JSON));
            return response;
        });
