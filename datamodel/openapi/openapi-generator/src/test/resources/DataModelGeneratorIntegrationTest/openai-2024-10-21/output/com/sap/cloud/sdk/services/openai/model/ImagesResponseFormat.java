...
public enum ImagesResponseFormat {
  ...
  ImagesResponseFormat(String value) {
    this.value = value;
  }
   ...
   */
  @JsonCreator
  public static ImagesResponseFormat fromValue(@Nonnull final String value) {
    for (final ImagesResponseFormat b : ImagesResponseFormat.values()) {
