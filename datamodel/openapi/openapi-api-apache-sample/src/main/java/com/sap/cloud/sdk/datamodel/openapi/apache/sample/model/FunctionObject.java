...
// CHECKSTYLE:ON
{
     ...
     *
     * @param name
     *            The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with
     ...
     *
     * @param key
     *            The String key of this parameters instance
     * @param parametersItem
     *            The parameters that should be added under the given key
     * @return The same instance of type {@link FunctionObject}
     */
    @Nonnull
    public FunctionObject putparametersItem( @Nonnull final String key, @Nullable final Object parametersItem )
    {
     ...
     * The parameters the functions accepts, described as a JSON Schema object. See the
     * [guide](https://platform.openai.com/docs/guides/function-calling) for examples, and the [JSON Schema
     * reference](https://json-schema.org/understanding-json-schema/) for documentation about the format. Omitting
     ...
     *
     * @param strict
     *            Whether to enable strict schema adherence when generating the function call. If set to true, the model
     *            will follow the exact schema defined in the &#x60;parameters&#x60; field. Only a subset of JSON Schema
     ...
     * follow the exact schema defined in the &#x60;parameters&#x60; field. Only a subset of JSON Schema is supported
     * when &#x60;strict&#x60; is &#x60;true&#x60;. Learn more about Structured Outputs in the [function calling
    ...
    public Map<String, Object> toMap()
    {
        ...
        if( description != null )
            declaredFields.put("description", description);
        if( name != null )
            declaredFields.put("name", name);
        if( parameters != null )
            declaredFields.put("parameters", parameters);
        if( strict != null )
            declaredFields.put("strict", strict);
