...
// CHECKSTYLE:ON
{
     ...
     *
     * @param key
     *            The String key of this schema instance
     * @param schemaItem
     *            The schema that should be added under the given key
     * @return The same instance of type {@link ResponseFormatJsonSchemaJsonSchema}
     */
    @Nonnull
    public
        ResponseFormatJsonSchemaJsonSchema
        putschemaItem( @Nonnull final String key, @Nullable final Object schemaItem )
    {
        if( this.schema == null ) {
     ...
     *            always follow the exact schema defined in the &#x60;schema&#x60; field. Only a subset of JSON Schema
     *            is supported when &#x60;strict&#x60; is &#x60;true&#x60;. To learn more, read the [Structured Outputs
    ...
    /**
     * Get the value of all properties of this {@link ResponseFormatJsonSchemaJsonSchema} instance including
    ...
    public Map<String, Object> toMap()
    {
        ...
        if( schema != null )
            declaredFields.put("schema", schema);
        if( strict != null )
    ...
    /**
     * Set an unrecognizable property of this {@link ResponseFormatJsonSchemaJsonSchema} instance. If the map previously
