...
public class IsStoreOpenFluentHelper extends SingleValuedFluentHelperFunction<IsStoreOpenFluentHelper, Boolean, Boolean>
{
     ...
     */
    public IsStoreOpenFluentHelper( @Nonnull final String servicePath, @Nonnull final LocalDateTime dateTime )
    {
        super(servicePath);
    ...
    @Override
    @Nullable
    public Boolean executeRequest( @Nonnull final Destination destination )
    {
