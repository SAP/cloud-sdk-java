...
/**
 * Fluent helper to fetch a single {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Shelf
 * Shelf} entity using key fields. This fluent helper allows methods which modify the underlying query to be called
...
public class ShelfByKeyFluentHelper extends FluentHelperByKey<ShelfByKeyFluentHelper, Shelf, ShelfSelectable>
{
     ...
     * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Shelf Shelf} entity with the provided
