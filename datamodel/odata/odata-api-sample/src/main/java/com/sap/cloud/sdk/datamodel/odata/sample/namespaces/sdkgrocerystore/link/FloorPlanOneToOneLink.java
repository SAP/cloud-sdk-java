 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.FloorPlan FloorPlan} to other entities,
 * where the cardinality of the related entity is at most 1. This class extends
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.FloorPlanLink FloorPlanLink} and
 ...
 *
 */
public class FloorPlanOneToOneLink<ObjectT extends VdmObject<?>> extends FloorPlanLink<ObjectT>
    implements
    OneToOneLink<FloorPlan, ObjectT>
{
     ...
     */
    public FloorPlanOneToOneLink( final String fieldName )
    {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FloorPlan> filter( @Nonnull final ExpressionFluentHelper<ObjectT> filterExpression )
    {
