...
/**
 * Fluent helper to fetch a single {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Address
 * Address} entity using key fields. This fluent helper allows methods which modify the underlying query to be called
...
public class AddressByKeyFluentHelper extends FluentHelperByKey<AddressByKeyFluentHelper, Address, AddressSelectable>
{
     ...
     * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Address Address} entity with the
