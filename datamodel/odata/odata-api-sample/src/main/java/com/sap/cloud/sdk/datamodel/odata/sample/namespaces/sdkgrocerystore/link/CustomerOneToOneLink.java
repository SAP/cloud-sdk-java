 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Customer Customer} to other entities,
 * where the cardinality of the related entity is at most 1. This class extends
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.CustomerLink CustomerLink} and
 ...
 *
 */
public class CustomerOneToOneLink<ObjectT extends VdmObject<?>> extends CustomerLink<ObjectT>
    implements
    OneToOneLink<Customer, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Customer> filter( @Nonnull final ExpressionFluentHelper<ObjectT> filterExpression )
    {
