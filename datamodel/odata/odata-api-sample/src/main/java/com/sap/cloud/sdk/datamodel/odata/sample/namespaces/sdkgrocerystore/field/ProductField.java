...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Product Product}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ProductField<FieldT >
    extends EntityField<Product, FieldT>
    implements ProductSelectable
{
     ...
     */
    public ProductField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ProductField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
