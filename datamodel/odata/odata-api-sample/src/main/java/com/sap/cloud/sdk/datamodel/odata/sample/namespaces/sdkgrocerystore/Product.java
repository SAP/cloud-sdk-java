...
import com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.field.ProductField;
import com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.ProductLink;
import com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.ProductOneToOneLink;
...
public class Product extends VdmMediaEntity<Product>
{
     ...
     * </p>
     *
     * @return The shelfId contained in this entity.
     */
     ...
     * </p>
     *
     * @return The vendorId contained in this entity.
     */
     ...
     * </p>
     *
     * @return The price contained in this entity.
     */
     ...
     * Constraints: none
     * <p>
     * Original property name from the Odata EDM: <b>Image</b>
     * </p>
     *
     * @return The image contained in this entity.
     */
     ...
     *            The image to set.
     */
    public void setImage( @Nullable final byte[] image )
    {
    ...
    /**
     * Fetches the <b>Vendor</b> entity (one to one) associated with this entity. This corresponds to the OData
     * navigation property <b>Vendor</b>.
     * <p>
     * Please note: This method will not cache or persist the query results.
     *
     * @return The single associated <b>Vendor</b> entity, or {@code null} if an entity is not associated.
     ...
     * <b>Vendor</b>.
     * <p>
     * If the navigation property <b>Vendor</b> of a queried <b>Product</b> is operated lazily, an <b>ODataException</b>
     ...
     *
     * @return List of associated <b>Vendor</b> entity.
     * @throws ODataException
     *             If the entity is unmanaged, i.e. it has not been retrieved using the OData VDM's services and
     *             therefore has no ERP configuration context assigned. An entity is managed if it has been either
     *             retrieved using the VDM's services or returned from the VDM's services as the result of a CREATE or
    ...
    /**
     * Fetches the <b>Shelf</b> entities (one to many) associated with this entity. This corresponds to the OData
     * navigation property <b>Shelf</b>.
     * <p>
     * Please note: This method will not cache or persist the query results.
     *
     * @return List containing one or more associated <b>Shelf</b> entities. If no entities are associated then an empty
     *         list is returned.
     * @throws ODataException
     *             If the entity is unmanaged, i.e. it has not been retrieved using the OData VDM's services and
     *             therefore has no ERP configuration context assigned. An entity is managed if it has been either
    ...
    /**
     * Retrieval of associated <b>Shelf</b> entities (one to many). This corresponds to the OData navigation property
     * <b>Shelf</b>.
     * <p>
     * If the navigation property <b>Shelf</b> of a queried <b>Product</b> is operated lazily, an <b>ODataException</b>
     * can be thrown in case of an OData query error.
     * <p>
     * Please note: <i>Lazy</i> loading of OData entity associations is the process of asynchronous retrieval and
     * persisting of items from a navigation property. If a <i>lazy</i> property is requested by the application for the
     ...
     * and its result will get cached for future invocations.
     *
     * @return List of associated <b>Shelf</b> entities.
     * @throws ODataException
     *             If the entity is unmanaged, i.e. it has not been retrieved using the OData VDM's services and
     *             therefore has no ERP configuration context assigned. An entity is managed if it has been either
     *             retrieved using the VDM's services or returned from the VDM's services as the result of a CREATE or
     ...
     *         <b>Shelf</b> entities. If not, an <code>Option</code> with result state <code>empty</code> is returned.
     */
    @Nonnull
    ...
    /**
     * Adds elements to the list of associated <b>Shelf</b> entities. This corresponds to the OData navigation property
     * <b>Shelf</b>.
     * <p>
     * If the navigation property <b>Shelf</b> of a queried <b>Product</b> is operated lazily, an <b>ODataException</b>
     * can be thrown in case of an OData query error.
