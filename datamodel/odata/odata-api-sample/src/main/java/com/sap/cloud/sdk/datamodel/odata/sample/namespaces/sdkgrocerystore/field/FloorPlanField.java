 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.FloorPlan FloorPlan}. Instances of this
 * object are used in query modifier methods of the entity fluent helpers. Contains methods to compare a field's value
 ...
 *
 */
public class FloorPlanField<FieldT> extends EntityField<FloorPlan, FieldT> implements FloorPlanSelectable
{
     ...
     */
    public FloorPlanField( final String fieldName )
    {
        super(fieldName);
    }
     ...
     *            OData field name. Must match the field returned by the underlying OData service.
     */
    public FloorPlanField( final String fieldName, final TypeConverter<FieldT, ?> typeConverter )
    {
