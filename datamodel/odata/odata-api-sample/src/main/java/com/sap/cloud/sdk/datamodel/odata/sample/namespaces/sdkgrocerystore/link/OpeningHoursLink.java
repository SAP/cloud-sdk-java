 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.OpeningHours OpeningHours} to other
...
public class OpeningHoursLink<ObjectT extends VdmObject<?>>
    extends
    EntityLink<OpeningHoursLink<ObjectT>, OpeningHours, ObjectT>
    implements
    OpeningHoursSelectable
{
    ...
    @Nonnull
    @Override
    protected OpeningHoursLink<ObjectT> translateLinkType(
        final EntityLink<OpeningHoursLink<ObjectT>, OpeningHours, ObjectT> link )
    {
