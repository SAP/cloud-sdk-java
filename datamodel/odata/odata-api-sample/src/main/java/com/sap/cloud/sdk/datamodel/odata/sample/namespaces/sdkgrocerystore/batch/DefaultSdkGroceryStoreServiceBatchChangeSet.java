...
/**
 * Implementation of the {@link SdkGroceryStoreServiceBatchChangeSet} interface, enabling you to combine multiple
 * operations into one changeset. For further information have a look into the
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.services.SdkGroceryStoreService SdkGroceryStoreService}.
 *
 */
public class DefaultSdkGroceryStoreServiceBatchChangeSet
    extends
    BatchChangeSetFluentHelperBasic<SdkGroceryStoreServiceBatch, SdkGroceryStoreServiceBatchChangeSet>
    implements
    SdkGroceryStoreServiceBatchChangeSet
{
    ...
    DefaultSdkGroceryStoreServiceBatchChangeSet(
        @Nonnull final DefaultSdkGroceryStoreServiceBatch batchFluentHelper,
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet createCustomer( @Nonnull final Customer customer )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet createProduct( @Nonnull final Product product )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet updateProduct( @Nonnull final Product product )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet createReceipt( @Nonnull final Receipt receipt )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet createAddress( @Nonnull final Address address )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet updateAddress( @Nonnull final Address address )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet deleteAddress( @Nonnull final Address address )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet createShelf( @Nonnull final Shelf shelf )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet updateShelf( @Nonnull final Shelf shelf )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet deleteShelf( @Nonnull final Shelf shelf )
    {
    ...
    @Nonnull
    @Override
    public SdkGroceryStoreServiceBatchChangeSet updateOpeningHours( @Nonnull final OpeningHours openingHours )
    {
