...
/**
 * Fluent helper to fetch a single {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Receipt
 * Receipt} entity using key fields. This fluent helper allows methods which modify the underlying query to be called
...
public class ReceiptByKeyFluentHelper extends FluentHelperByKey<ReceiptByKeyFluentHelper, Receipt, ReceiptSelectable>
{
     ...
     * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Receipt Receipt} entity with the
