 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Product Product} to other entities, where
 * the cardinality of the related entity is at most 1. This class extends
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.ProductLink ProductLink} and provides
 ...
 *
 */
public class ProductOneToOneLink<ObjectT extends VdmObject<?>> extends ProductLink<ObjectT>
    implements
    OneToOneLink<Product, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Product> filter( @Nonnull final ExpressionFluentHelper<ObjectT> filterExpression )
    {
