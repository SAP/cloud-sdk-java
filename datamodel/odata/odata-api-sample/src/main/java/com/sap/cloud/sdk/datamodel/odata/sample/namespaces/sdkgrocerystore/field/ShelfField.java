 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Shelf Shelf}. Instances of this object are
 * used in query modifier methods of the entity fluent helpers. Contains methods to compare a field's value with a
 * provided value.
 *
 ...
 *
 */
public class ShelfField<FieldT> extends EntityField<Shelf, FieldT> implements ShelfSelectable
{
     ...
     */
    public ShelfField( final String fieldName )
    {
        super(fieldName);
    }
     ...
     *            OData field name. Must match the field returned by the underlying OData service.
     */
    public ShelfField( final String fieldName, final TypeConverter<FieldT, ?> typeConverter )
    {
