 ...
 *
 */
public class FloorPlanLink<ObjectT extends VdmObject<?>> extends EntityLink<FloorPlanLink<ObjectT>, FloorPlan, ObjectT>
    implements
    FloorPlanSelectable
{
    ...
    @Nonnull
    @Override
    protected FloorPlanLink<ObjectT> translateLinkType(
        final EntityLink<FloorPlanLink<ObjectT>, FloorPlan, ObjectT> link )
    {
