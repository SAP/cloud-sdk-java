 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Shelf Shelf} to other entities, where the
 * cardinality of the related entity is at most 1. This class extends
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.ShelfLink ShelfLink} and provides an
 ...
 *
 */
public class ShelfOneToOneLink<ObjectT extends VdmObject<?>> extends ShelfLink<ObjectT>
    implements
    OneToOneLink<Shelf, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Shelf> filter( @Nonnull final ExpressionFluentHelper<ObjectT> filterExpression )
    {
