...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Receipt Receipt} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.ReceiptLink ReceiptLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ReceiptOneToOneLink<ObjectT extends VdmObject<?> >
    extends ReceiptLink<ObjectT>
    implements OneToOneLink<Receipt, ObjectT>
{
     ...
     */
    public ReceiptOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Receipt> filter(
        @Nonnull
