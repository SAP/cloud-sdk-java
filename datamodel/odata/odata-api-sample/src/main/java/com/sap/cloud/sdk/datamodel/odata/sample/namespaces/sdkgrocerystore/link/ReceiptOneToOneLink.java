 ...
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Receipt Receipt} to other entities, where
 * the cardinality of the related entity is at most 1. This class extends
 * {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.ReceiptLink ReceiptLink} and provides
 ...
 *
 */
public class ReceiptOneToOneLink<ObjectT extends VdmObject<?>> extends ReceiptLink<ObjectT>
    implements
    OneToOneLink<Receipt, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Receipt> filter( @Nonnull final ExpressionFluentHelper<ObjectT> filterExpression )
    {
