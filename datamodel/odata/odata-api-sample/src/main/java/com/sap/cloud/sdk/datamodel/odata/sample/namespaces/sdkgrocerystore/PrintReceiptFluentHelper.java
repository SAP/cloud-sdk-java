...
/**
 * Fluent helper for the <b>PrintReceipt</b> OData function import.
 *
 */
public class PrintReceiptFluentHelper extends SingleValuedFluentHelperFunction<PrintReceiptFluentHelper, String, String>
{
     ...
     *            </p>
     */
    public PrintReceiptFluentHelper( @Nonnull final String servicePath, @Nonnull final Integer receiptId )
    {
        super(servicePath);
