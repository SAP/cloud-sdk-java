...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.Vendor Vendor} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.datamodel.odata.sample.namespaces.sdkgrocerystore.link.VendorLink VendorLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class VendorOneToOneLink<ObjectT extends VdmObject<?> >
    extends VendorLink<ObjectT>
    implements OneToOneLink<Vendor, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Vendor> filter(
        @Nonnull
