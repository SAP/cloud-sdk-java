...
public class DataModelGeneratorMojo extends AbstractMojo
{
     ...
     */
    @Parameter(
        property = "odatav2.generate.inputDirectory",
     ...
     */
    @Parameter(
        property = "odatav2.generate.outputDirectory",
     ...
     */
    @Parameter( property = "odatav2.generate.packageName", defaultValue = DataModelGenerator.DEFAULT_PACKAGE_NAME )
     ...
     */
    @Parameter(
        property = "odatav2.generate.serviceNameMappingFile",
    ...
    /**
     * The fully specified path to the class implementing the
     * {@link com.sap.cloud.sdk.datamodel.odata.utility.NamingStrategy} interface.
     * <p>
     * This class is then used to map the edm names to java names.
     */
    @Parameter(
        property = "odatav2.generate.namingStrategy",
     ...
     */
    @Parameter(
        property = "odatav2.generate.annotationStrategy",
