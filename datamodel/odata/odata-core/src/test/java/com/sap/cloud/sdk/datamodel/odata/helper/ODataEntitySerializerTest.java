...
class ODataEntitySerializerTest
{
    ...
    void testSerializeEntityForUpdatePatchNested() {
        ...
        final TestVdmComplex childComplex = TestVdmComplex.builder().someValue("initialChildValue").complexValue(grandchildComplex).build();
        final TestVdmEntity rootEntity = TestVdmEntity.builder().stringValue("initialRootValue").booleanValue(false).complexValue(childComplex).build();
        ...
        final String fullPayload = ODataEntitySerializer.serializeEntityForUpdatePatchRecursiveFull(rootEntity, additionalFields);
        assertThat(fullPayload).isEqualTo("{\"customField\":null,\"StringValue\":\"newRootValue\",\"ComplexValue\":{\"SomeValue\":\"initialChildValue\",\"OtherValue\":null,\"ComplexValue\":{\"SomeValue\":\"newGrandchildValue\",\"OtherValue\":null,\"ComplexValue\":null}}}");
        
        final String deltaPayload = ODataEntitySerializer.serializeEntityForUpdatePatchRecursiveDelta(rootEntity, additionalFields);
        assertThat(deltaPayload).isEqualTo("{\"customField\":null,\"ComplexValue\":{\"ComplexValue\":{\"SomeValue\":\"newGrandchildValue\"}},\"StringValue\":\"newRootValue\"}");
        
        final TestVdmComplex siblingGrandchildComplex = TestVdmComplex.builder().someValue("newSiblingGrandchildValue").build();
        childComplex.setComplexValue(siblingGrandchildComplex);
        
        final String siblingDeltaPayload = ODataEntitySerializer.serializeEntityForUpdatePatchRecursiveDelta(rootEntity, additionalFields);
        assertThat(siblingDeltaPayload).isEqualTo("{\"customField\":null,\"ComplexValue\":{\"ComplexValue\":{\"SomeValue\":\"newSiblingGrandchildValue\",\"OtherValue\":null,\"ComplexValue\":null}},\"StringValue\":\"newRootValue\"}");
    }
