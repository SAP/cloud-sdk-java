...
class ServiceClassGeneratorTest
{
    ...
    private ServiceBatchChangeSetGenerator batchChangeSetGenerator;
    private ServiceBatchGenerator batchGenerator;
    private DefaultServiceBatchGenerator defaultBatchGenerator;
    private DefaultServiceBatchChangeSetGenerator defaultServiceBatchChangeSetGenerator;
    ...
    void setUp()
    {
        ...
        batchChangeSetGenerator = new ServiceBatchChangeSetGenerator(model);
        batchGenerator = new ServiceBatchGenerator(model);
        defaultBatchGenerator = new DefaultServiceBatchGenerator(model);
        defaultServiceBatchChangeSetGenerator = new DefaultServiceBatchChangeSetGenerator(model);
