...
/**
 * Fluent helper to delete an existing {@link testcomparison.namespaces.multipleentitysets.SimplePerson SimplePerson} entity in the S/4HANA system.<p>
    ...
    extends FluentHelperDelete<SimplePersonDeleteFluentHelper, SimplePerson>
{
    ...
    /**
     * Creates a fluent helper object that will delete a {@link testcomparison.namespaces.multipleentitysets.SimplePerson SimplePerson} entity on the OData endpoint. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
