...
/**
 * Fluent helper to update an existing {@link testcomparison.namespaces.multipleentitysets.SimplePerson SimplePerson} entity and save it to the S/4HANA system.<p>
    ...
    extends FluentHelperUpdate<SimplePersonUpdateFluentHelper, SimplePerson>
{
    ...
    /**
     * Creates a fluent helper object that will update a {@link testcomparison.namespaces.multipleentitysets.SimplePerson SimplePerson} entity on the OData endpoint. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     *
     * @param servicePath
