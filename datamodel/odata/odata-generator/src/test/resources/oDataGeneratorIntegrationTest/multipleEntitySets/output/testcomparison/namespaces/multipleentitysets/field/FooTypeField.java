...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.multipleentitysets.FooType FooType}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class FooTypeField<FieldT >
    extends EntityField<FooType, FieldT>
    implements FooTypeSelectable
{
     ...
     */
    public FooTypeField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public FooTypeField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
