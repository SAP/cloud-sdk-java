...
package testcomparison.namespaces.entitywithkeynamedfield.field;
...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.entitywithkeynamedfield.EntityWithoutKeyLabel EntityWithoutKeyLabel}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EntityWithoutKeyLabelField<FieldT >
    extends EntityField<EntityWithoutKeyLabel, FieldT>
    implements EntityWithoutKeyLabelSelectable
{
     ...
     */
    public EntityWithoutKeyLabelField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public EntityWithoutKeyLabelField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
