...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.entitywithkeynamedfield.SomeTypeLabel SomeTypeLabel}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SomeTypeLabelField<FieldT >
    extends EntityField<SomeTypeLabel, FieldT>
    implements SomeTypeLabelSelectable
{
     ...
     */
    public SomeTypeLabelField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SomeTypeLabelField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
