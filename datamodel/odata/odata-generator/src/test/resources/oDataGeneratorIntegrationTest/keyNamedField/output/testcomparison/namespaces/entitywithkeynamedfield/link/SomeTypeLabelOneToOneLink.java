...
/**
 * Template class to represent entity navigation links of {@link testcomparison.namespaces.entitywithkeynamedfield.SomeTypeLabel SomeTypeLabel} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link testcomparison.namespaces.entitywithkeynamedfield.link.SomeTypeLabelLink SomeTypeLabelLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SomeTypeLabelOneToOneLink<ObjectT extends VdmObject<?> >
    extends SomeTypeLabelLink<ObjectT>
    implements OneToOneLink<SomeTypeLabel, ObjectT>
{
     ...
     */
    public SomeTypeLabelOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SomeTypeLabel> filter(
        @Nonnull
