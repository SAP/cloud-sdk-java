...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.test.TestEntityLvl2SingleLink TestEntityLvl2SingleLink}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TestEntityLvl2SingleLinkField<FieldT >
    extends EntityField<TestEntityLvl2SingleLink, FieldT>
    implements TestEntityLvl2SingleLinkSelectable
{
     ...
     */
    public TestEntityLvl2SingleLinkField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TestEntityLvl2SingleLinkField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
