 ...
 * <li>{@link testcomparison.namespaces.test.TestEntityV2#TO_MULTI_LINK TO_MULTI_LINK}</li>
 * <li>{@link testcomparison.namespaces.test.TestEntityV2#TO_OTHER_MULTI_LINK TO_OTHER_MULTI_LINK}</li>
 * <li>{@link testcomparison.namespaces.test.TestEntityV2#TO_SINGLE_LINK TO_SINGLE_LINK}</li>
 * </ul>
 * 
 */
