...
/**
 * Fluent helper for the <b>TestFunctionImportEdmReturnTypeCollection</b> OData function import.
 * 
 */
public class TestFunctionImportEdmReturnTypeCollectionFluentHelper
    extends CollectionValuedFluentHelperFunction<TestFunctionImportEdmReturnTypeCollectionFluentHelper, String, List<String>>
{
     ...
     */
    public TestFunctionImportEdmReturnTypeCollectionFluentHelper(
        @Nonnull
    ...
    protected String getFunctionName() {
        return "TestFunctionImportEdmReturnTypeCollection";
    }
    ...
    @Override
    @Nonnull
    public List<String> executeRequest(
        @Nonnull
