...
/**
 * Fluent helper to fetch a single {@link testcomparison.namespaces.test.TestEntityV2 TestEntityV2} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
    ...
    extends FluentHelperByKey<TestEntityV2ByKeyFluentHelper, TestEntityV2, TestEntityV2Selectable>
{
    ...
    public TestEntityV2ByKeyFluentHelper(
        ...
        @Nonnull
        final String entityCollection, final UUID keyPropertyGuid, final String keyPropertyString) {
        super(servicePath, entityCollection);
        this.key.put("KeyPropertyGuid", keyPropertyGuid);
        this.key.put("KeyPropertyString", keyPropertyString);
    }
