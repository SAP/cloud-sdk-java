...
/**
 * Fluent helper for the <b>TestFunctionImportEntityReturnTypeCollection</b> OData function import.
 * 
 */
public class TestFunctionImportEntityReturnTypeCollectionFluentHelper
    extends CollectionValuedFluentHelperFunction<TestFunctionImportEntityReturnTypeCollectionFluentHelper, TestEntityV2, List<TestEntityV2>>
{
     ...
     */
    public TestFunctionImportEntityReturnTypeCollectionFluentHelper(
        @Nonnull
    ...
    protected String getFunctionName() {
        return "TestFunctionImportEntityReturnTypeCollection";
    }
    ...
    @Override
    @Nonnull
    public List<TestEntityV2> executeRequest(
        @Nonnull
