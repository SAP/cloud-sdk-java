...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.test.Unrelated Unrelated}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class UnrelatedField<FieldT >
    extends EntityField<Unrelated, FieldT>
    implements UnrelatedSelectable
{
     ...
     */
    public UnrelatedField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public UnrelatedField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
