...
/**
 * Template class to represent entity navigation links of {@link testcomparison.namespaces.test.Unrelated Unrelated} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link testcomparison.namespaces.test.link.UnrelatedLink UnrelatedLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class UnrelatedOneToOneLink<ObjectT extends VdmObject<?> >
    extends UnrelatedLink<ObjectT>
    implements OneToOneLink<Unrelated, ObjectT>
{
     ...
     */
    public UnrelatedOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Unrelated> filter(
        @Nonnull
