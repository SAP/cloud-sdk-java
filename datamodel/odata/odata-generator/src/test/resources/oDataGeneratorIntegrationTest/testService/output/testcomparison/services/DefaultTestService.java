    ...
    implements TestService
{
    ...
    @Override
    @Nonnull
    public TestFunctionImportUnprecedentedComplexReturnFluentHelper testFunctionImportUnprecedentedComplexReturnType() {
        return new TestFunctionImportUnprecedentedComplexReturnFluentHelper(servicePath);
    }
