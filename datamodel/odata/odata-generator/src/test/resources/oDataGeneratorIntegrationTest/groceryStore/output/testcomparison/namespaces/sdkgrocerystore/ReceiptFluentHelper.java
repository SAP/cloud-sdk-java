...
/**
 * Fluent helper to fetch multiple {@link testcomparison.namespaces.sdkgrocerystore.Receipt Receipt} entities. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
