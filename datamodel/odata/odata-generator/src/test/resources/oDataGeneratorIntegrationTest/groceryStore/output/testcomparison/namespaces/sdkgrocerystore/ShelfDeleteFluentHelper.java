...
/**
 * Fluent helper to delete an existing {@link testcomparison.namespaces.sdkgrocerystore.Shelf Shelf} entity in the S/4HANA system.<p>
    ...
    extends FluentHelperDelete<ShelfDeleteFluentHelper, Shelf>
{
    ...
    /**
     * Creates a fluent helper object that will delete a {@link testcomparison.namespaces.sdkgrocerystore.Shelf Shelf} entity on the OData endpoint. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
