...
import testcomparison.namespaces.sdkgrocerystore.field.VendorField;
import testcomparison.namespaces.sdkgrocerystore.link.VendorOneToOneLink;
import testcomparison.namespaces.sdkgrocerystore.selectable.VendorSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>Vendor</b></p>
 * 
 */
@Builder
@Data
    ...
    extends VdmEntity<Vendor>
{
    ...
    /**
     * Constraints: Nullable<p>Original property name from the Odata EDM: <b>AddressId</b></p>
     * 
     * @return
     *     The addressId contained in this entity.
     */
     ...
     */
    @Nonnull
    public static<T >VendorField<T> field(
        @Nonnull
     ...
     * <p>
     * If the navigation property <b>Address</b> of a queried <b>Vendor</b> is operated lazily, an <b>ODataException</b> can be thrown in case of an OData query error.
     * <p>
     ...
     * Retrieval of associated <b>Address</b> entity (one to one). This corresponds to the OData navigation property <b>Address</b>.
     * <p>
     * If the navigation property for an entity <b>Vendor</b> has not been resolved yet, this method will <b>not query</b> further information. Instead its <code>Option</code> result state will be <code>empty</code>.
     * 
     * @return
