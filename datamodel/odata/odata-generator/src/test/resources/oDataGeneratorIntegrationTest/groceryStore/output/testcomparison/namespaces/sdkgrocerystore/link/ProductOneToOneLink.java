...
/**
 * Template class to represent entity navigation links of {@link testcomparison.namespaces.sdkgrocerystore.Product Product} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link testcomparison.namespaces.sdkgrocerystore.link.ProductLink ProductLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ProductOneToOneLink<ObjectT extends VdmObject<?> >
    extends ProductLink<ObjectT>
    implements OneToOneLink<Product, ObjectT>
{
     ...
     */
    public ProductOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Product> filter(
        @Nonnull
