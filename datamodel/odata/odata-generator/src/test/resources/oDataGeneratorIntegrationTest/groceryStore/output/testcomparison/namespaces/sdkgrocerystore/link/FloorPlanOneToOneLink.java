...
/**
 * Template class to represent entity navigation links of {@link testcomparison.namespaces.sdkgrocerystore.FloorPlan FloorPlan} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link testcomparison.namespaces.sdkgrocerystore.link.FloorPlanLink FloorPlanLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class FloorPlanOneToOneLink<ObjectT extends VdmObject<?> >
    extends FloorPlanLink<ObjectT>
    implements OneToOneLink<FloorPlan, ObjectT>
{
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<FloorPlan> filter(
        @Nonnull
