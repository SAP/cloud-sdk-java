...
/**
 * Fluent helper to fetch multiple {@link testcomparison.namespaces.minimalmetadata.SimplePerson SimplePerson} entities. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
