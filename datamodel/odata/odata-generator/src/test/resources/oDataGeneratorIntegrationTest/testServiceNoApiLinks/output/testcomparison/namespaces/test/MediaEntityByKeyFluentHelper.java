...
/**
 * Fluent helper to fetch a single {@link testcomparison.namespaces.test.MediaEntity MediaEntity} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
public class MediaEntityByKeyFluentHelper
    extends FluentHelperByKey<MediaEntityByKeyFluentHelper, MediaEntity, MediaEntitySelectable>
{
     ...
     *     Entity Collection to be used to fetch a single {@code MediaEntity}
     * @param keyProperty
     *     
     * @param servicePath
     *     Service path to be used to fetch a single {@code MediaEntity}
     */
    public MediaEntityByKeyFluentHelper(
        @Nonnull
