...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.test.TestEntityOtherMultiLink TestEntityOtherMultiLink}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TestEntityOtherMultiLinkField<FieldT >
    extends EntityField<TestEntityOtherMultiLink, FieldT>
    implements TestEntityOtherMultiLinkSelectable
{
     ...
     */
    public TestEntityOtherMultiLinkField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TestEntityOtherMultiLinkField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
