    ...
    extends FluentHelperBatchChangeSet<TestServiceBatchChangeSet> , FluentHelperBatchEndChangeSet<TestServiceBatch>
{
     ...
     */
    @Nonnull
    TestServiceBatchChangeSet createTestEntityEndsWithCollection(
        @Nonnull
     ...
     */
    @Nonnull
    TestServiceBatchChangeSet updateTestEntityEndsWithCollection(
        @Nonnull
        final Unrelated unrelated);
     ...
     */
    @Nonnull
    TestServiceBatchChangeSet deleteTestEntityEndsWithCollection(
        @Nonnull
        final Unrelated unrelated);
     ...
     */
    @Nonnull
    TestServiceBatchChangeSet createTestEntityEndsWithSomethingElse(
        @Nonnull
        final Unrelated unrelated);
     ...
     */
    @Nonnull
    TestServiceBatchChangeSet updateTestEntityEndsWithSomethingElse(
        @Nonnull
        final Unrelated unrelated);
     ...
     */
    @Nonnull
    TestServiceBatchChangeSet deleteTestEntityEndsWithSomethingElse(
        @Nonnull
        final Unrelated unrelated);
