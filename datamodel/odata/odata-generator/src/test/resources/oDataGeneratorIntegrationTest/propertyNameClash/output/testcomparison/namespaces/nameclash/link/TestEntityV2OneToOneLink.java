...
/**
 * Template class to represent entity navigation links of {@link testcomparison.namespaces.nameclash.TestEntityV2 TestEntityV2} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link testcomparison.namespaces.nameclash.link.TestEntityV2Link TestEntityV2Link} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class TestEntityV2OneToOneLink<ObjectT extends VdmObject<?> >
    extends TestEntityV2Link<ObjectT>
    implements OneToOneLink<TestEntityV2, ObjectT>
{
     ...
     */
    public TestEntityV2OneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<TestEntityV2> filter(
        @Nonnull
