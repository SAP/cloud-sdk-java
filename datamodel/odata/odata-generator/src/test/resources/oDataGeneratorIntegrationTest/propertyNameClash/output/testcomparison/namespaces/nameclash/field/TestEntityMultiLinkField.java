...
package testcomparison.namespaces.nameclash.field;
...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.nameclash.TestEntityMultiLink TestEntityMultiLink}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TestEntityMultiLinkField<FieldT >
    extends EntityField<TestEntityMultiLink, FieldT>
    implements TestEntityMultiLinkSelectable
{
     ...
     */
    public TestEntityMultiLinkField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TestEntityMultiLinkField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
