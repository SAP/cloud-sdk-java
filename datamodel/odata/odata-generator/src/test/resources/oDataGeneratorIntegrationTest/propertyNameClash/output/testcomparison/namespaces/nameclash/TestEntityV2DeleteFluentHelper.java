...
/**
 * Fluent helper to delete an existing {@link testcomparison.namespaces.nameclash.TestEntityV2 TestEntityV2} entity in the S/4HANA system.<p>
    ...
    extends FluentHelperDelete<TestEntityV2DeleteFluentHelper, TestEntityV2>
{
    ...
    /**
     * Creates a fluent helper object that will delete a {@link testcomparison.namespaces.nameclash.TestEntityV2 TestEntityV2} entity on the OData endpoint. To perform execution, call the {@link #executeRequest executeRequest} method on the fluent helper object.
     * 
