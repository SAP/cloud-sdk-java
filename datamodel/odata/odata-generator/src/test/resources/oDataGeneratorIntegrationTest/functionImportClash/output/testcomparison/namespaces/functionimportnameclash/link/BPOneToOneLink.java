...
/**
 * Template class to represent entity navigation links of {@link testcomparison.namespaces.functionimportnameclash.BP BP} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link testcomparison.namespaces.functionimportnameclash.link.BPLink BPLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BPOneToOneLink<ObjectT extends VdmObject<?> >
    extends BPLink<ObjectT>
    implements OneToOneLink<BP, ObjectT>
{
     ...
     */
    public BPOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BP> filter(
        @Nonnull
