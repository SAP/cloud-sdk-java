...
/**
 * Template class to represent entity fields of the Entity {@link testcomparison.namespaces.test.MediaEntity MediaEntity}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class MediaEntityField<FieldT >
    extends EntityField<MediaEntity, FieldT>
    implements MediaEntitySelectable
{
     ...
     */
    public MediaEntityField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public MediaEntityField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
