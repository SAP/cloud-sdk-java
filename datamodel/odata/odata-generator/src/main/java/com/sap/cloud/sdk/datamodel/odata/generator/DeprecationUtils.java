        ...
        final Service service )
    {
        createdMethod
            ...
            ._return(
                JExpr
                    .direct(
                        serviceInterface.fullName() + "." + ServiceClassGenerator.DEFAULT_SERVICE_PATH_FIELD_NAMING));
        ...
        if( service.isDeprecated() ) {
            ...
            createdMethod.annotate(SuppressWarnings.class).param("value", "deprecation");
        }
    }

    static void createBasicServiceInterfaceField(
        final JDefinedClass classToAddTheFieldTo,
        final JClass serviceInterface,
