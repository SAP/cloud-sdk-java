...
class FieldFunctionGenerator
{
    ...
    {
        fieldFunc.javadoc().add("Use with available fluent helpers to apply an extension field to query operations.");
        ...
        final String genericTypeConverterName )
    {
        fieldFuncWithTypeConverter
            .javadoc()
            .add("Use with available fluent helpers to apply an extension field to query operations.");
        fieldFuncWithTypeConverter
            .javadoc()
            .addReturn()
            .add(
