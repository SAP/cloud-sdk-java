...
public class DataModelGenerator implements DataModelGeneratorConfig
{
    ...
    /**
     * The default naming source used in the {@link NamingStrategy}.
     */
     ...
     *
     * @param nameSource
     *            The {@code NameSource} to be used by the {@link NamingStrategy}.
     * @return This {@code DataModelGenerator} for chained method calls.
     */
    @Nonnull
     ...
     * <p>
     * Defaults to the {@link com.sap.cloud.sdk.datamodel.odata.utility.S4HanaNamingStrategy} class.
     *
     ...
     *
     * @return A boolean indicating whether the generation led to warnings and also the flag for failing on warnings is
     *         activated.
     */
