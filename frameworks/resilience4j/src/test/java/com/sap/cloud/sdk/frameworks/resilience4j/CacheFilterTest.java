...
public class CacheFilterTest
{
    ...
    public void testCacheFilterFactoryMethodsForPrincipal()
    {
        ...
        CacheFilter specificPrincipalFilter =
            CacheFilter
                .keyMatchesPrincipal(new DefaultPrincipal(principalId, Collections.emptySet(), Collections.emptyMap()));
        assertThat(specificPrincipalFilter.matches(RESILIENCE_CONFIGURATION, cacheKey, null)).isTrue();

        specificPrincipalFilter =
            CacheFilter
                .keyMatchesPrincipal(
                    new DefaultPrincipal("other-principal", Collections.emptySet(), Collections.emptyMap()));
