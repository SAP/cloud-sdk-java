...
public class DefaultOAuth2PropertySupplier implements OAuth2PropertySupplier {
     ...
     *
     * @param options The options containing the service binding to interpret.
     ...
     *
     * @param options           The options containing the service binding to interpret.
     * @param oauthPropertyPath The path to the oauth properties in the service binding.
     ...
     *
     * @param <T>        The type of the entry to obtain.
     * @param resultType The type of the entry to obtain.
     * @param path       The path to the entry to obtain.
     * @return The entry from the credentials block of the service binding.
     * @throws DestinationAccessException If the property was not found or could not be converted to the requested type.
