...
public class ZeroTrustIdentityService {
    ...
    /**
     * Returns the X.509 SVID provided by the Zero Trust Identity Service.
     *
     * @return The X.509 SVID.
     */
    @Beta
    @Nonnull
     ...
     * This should always be equivalent to calling {@link #getX509Svid()} with {@link X509Svid#getSpiffeId()}.
     *
     ...
     * The KeyStore is cached and will be reloaded if the certificate expires.
     *
