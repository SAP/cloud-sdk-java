...
class TransparentProxyDestinationTest
{
    ...
    void testBuilderHeaderShortcutsDynamic()
    {
        ...
        assertThat(destination.getHeaders(URI.create(VALID_URI.toString())))
            ...
            .contains(
                TransparentProxyDestination.DESTINATION_NAME_HEADER_KEY,
                TransparentProxyDestination.FRAGMENT_NAME_HEADER_KEY,
                TransparentProxyDestination.TENANT_ID_HEADER_KEY,
                TransparentProxyDestination.FRAGMENT_OPTIONAL_HEADER_KEY,
                TransparentProxyDestination.TOKEN_SERVICE_TENANT_HEADER_KEY,
                TransparentProxyDestination.CLIENT_ASSERTION_HEADER_KEY,
                TransparentProxyDestination.CLIENT_ASSERTION_TYPE_HEADER_KEY,
                TransparentProxyDestination.CLIENT_ASSERTION_DESTINATION_NAME_HEADER_KEY,
                TransparentProxyDestination.AUTHORIZATION_HEADER_KEY,
                TransparentProxyDestination.SUBJECT_TOKEN_TYPE_HEADER_KEY,
                TransparentProxyDestination.ACTOR_TOKEN_HEADER_KEY,
                TransparentProxyDestination.ACTOR_TOKEN_TYPE_HEADER_KEY,
                TransparentProxyDestination.REDIRECT_URI_HEADER_KEY,
                TransparentProxyDestination.CODE_VERIFIER_HEADER_KEY,
                TransparentProxyDestination.CHAIN_NAME_HEADER_KEY,
                TransparentProxyDestination.CHAIN_VAR_SUBJECT_TOKEN_HEADER_KEY,
    ...
    void testBuilderHeaderShortcutsStatic()
    {
        ...
        assertThat(destination.getHeaders(URI.create(VALID_URI.toString())))
            .extracting(Header::getName)
            .contains(
                TransparentProxyDestination.TENANT_SUBDOMAIN_HEADER_KEY,
                TransparentProxyDestination.TOKEN_SERVICE_TENANT_HEADER_KEY,
                TransparentProxyDestination.CLIENT_ASSERTION_HEADER_KEY,
                TransparentProxyDestination.CLIENT_ASSERTION_TYPE_HEADER_KEY,
                TransparentProxyDestination.CLIENT_ASSERTION_DESTINATION_NAME_HEADER_KEY,
