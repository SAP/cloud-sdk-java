...
class TransparentProxyTest
{
        ...
        throws IOException
    {
        ...
        Try<Destination> result = loader.tryGetDestination("non-existent-destination");

        assertThat(result.isFailure()).isTrue();
        assertThat(result.getCause()).isInstanceOf(DestinationAccessException.class);
        assertThat(result.getCause().getMessage()).contains("Destination not found: non-existent-destination");
    }
        ...
        throws IOException
    {
        ...
        Try<Destination> result = loader.tryGetDestination("non-existent-destination", null);
        ...
        throws IOException
    {
        ...
        Try<Destination> result = loader.tryGetDestination("existing-destination");
        ...
        throws IOException
    {
        ...
        Try<Destination> result = loader.tryGetDestination("destination-with-502");
        ...
        throws IOException
    {
        ...
        Try<Destination> result = loader.tryGetDestination("destination-with-different-error");
    ...
    @Test
    void testDestinationFoundWhenIOExceptionOccurs()
        throws IOException
    {
        TransparentProxy.register("gateway");

        final HttpClient mockHttpClient = mock(HttpClient.class);
        when(mockHttpClient.execute(org.mockito.ArgumentMatchers.any(HttpHead.class)))
            .thenThrow(new IOException("Connection refused"));
        HttpClientAccessor.setHttpClientFactory(dest -> mockHttpClient);

        Try<Destination> result = loader.tryGetDestination("destination-with-io-error");
