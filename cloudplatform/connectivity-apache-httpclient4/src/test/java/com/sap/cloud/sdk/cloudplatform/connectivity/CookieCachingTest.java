...
public class CookieCachingTest
{
    @Rule
    public final WireMockRule rule = new WireMockRule(options().dynamicPort());
    ...
    {
        destination = DefaultHttpDestination.builder(rule.baseUrl()).build();
    }
