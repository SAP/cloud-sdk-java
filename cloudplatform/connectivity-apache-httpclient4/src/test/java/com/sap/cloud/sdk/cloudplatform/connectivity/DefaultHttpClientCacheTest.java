...
public class DefaultHttpClientCacheTest
{
    ...
    private static final Principal PRINCIPAL = new TestPrincipal("P");
    ...
    public void testGetClientWithoutDestinationUsesTenantAndPrincipalOptionalForIsolation()
    {
        ...
        final Principal[] principalsToTest = { new TestPrincipal("P#1"), new TestPrincipal("P#2"), PRINCIPAL_NONE };
    ...
    public void testInvalidatePrincipalCacheEntries()
    {
        ...
        mockedPrincipal = new TestPrincipal(untestedPrincipalId);
        ...
        for( final String principalId : principalsToTest ) {
            mockedPrincipal = principalId != null ? new TestPrincipal(principalId) : PRINCIPAL_NONE;
    ...
    // helper class to improve local formatting
