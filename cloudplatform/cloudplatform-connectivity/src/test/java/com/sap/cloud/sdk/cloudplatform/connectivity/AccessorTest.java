...
public class AccessorTest
{
    ...
    {
        TestPrincipal( @Nonnull final String principalId )
        {
        ...
        TenantAccessor.executeWithTenant(() -> "tenant", () -> {
            ...
            PrincipalAccessor.executeWithPrincipal(new TestPrincipal("principal"), () -> {
                ...
                TenantAccessor.executeWithTenant(() -> "overridden-tenant", () -> {
                    ...
                    PrincipalAccessor.executeWithPrincipal(new TestPrincipal("overridden-principal"), () -> {
                        assertTenantId("overridden-tenant");
    ...
    public void testNestingWithFallback()
    {
        ...
        TenantAccessor.executeWithFallbackTenant(() -> () -> "tenant", () -> {
            ...
            PrincipalAccessor.executeWithFallbackPrincipal(() -> new TestPrincipal("principal"), () -> {
                assertTenantId("tenant");
                assertPrincipalId("principal");
            });
    ...
    public void testNestingWithGlobalFallback()
    {
        ...
        PrincipalAccessor.executeWithFallbackPrincipal(() -> new TestPrincipal("fallback-principal"), () -> {
            assertTenantId("global-tenant");
