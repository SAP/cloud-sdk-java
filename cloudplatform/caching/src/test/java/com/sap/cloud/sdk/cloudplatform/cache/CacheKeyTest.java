...
public class CacheKeyTest
{
    ...
    {
        PrincipalAccessor.setPrincipalFacade(() -> Try.success(new DefaultPrincipal("P", emptySet(), emptyMap())));
    ...
    public void testOf()
    {
        ...
        final Principal principal = new DefaultPrincipal("user", emptySet(), emptyMap());
