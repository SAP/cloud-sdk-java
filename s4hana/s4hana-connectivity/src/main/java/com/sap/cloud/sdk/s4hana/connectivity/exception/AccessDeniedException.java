...
public class AccessDeniedException extends RequestExecutionException
{
    ...
    @Getter
    @Nullable
    protected transient Set<com.sap.cloud.sdk.cloudplatform.security.Authorization> missingAuthorizations = null;
    ...
    public static AccessDeniedException raiseMissingAuthorizations(
        ...
        @Nullable final Iterable<? extends com.sap.cloud.sdk.cloudplatform.security.Authorization> missingAuthorizations )
    {
    ...
    public AccessDeniedException(
        @Nullable final Principal principal,
        @Nullable final Set<com.sap.cloud.sdk.cloudplatform.security.Authorization> missingAuthorizations )
    {
